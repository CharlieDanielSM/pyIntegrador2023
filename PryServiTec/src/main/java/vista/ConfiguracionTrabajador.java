 ...
 * @author Adria
 */
public class ConfiguracionTrabajador extends javax.swing.JFrame {
    ...
    int validacion=1;
    public ConfiguracionTrabajador(empleador empleador) {
...
if (textoOriginal.length() >= 2) {
                    ...
                    if(validarletra(nombre)==true ){
                        ...
                        if (respuesta == JOptionPane.YES_OPTION) {
                            System.out.println("El usuario seleccionó Sí.");                                                
                             ...
                             X.ACTUALIZATRABA(nombre, apellido, telefono, correo, usuario, cpdeespe, nuevouser);
                            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfiguracionTrabajador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfiguracionTrabajador(null).setVisible(true);
            }
        });
    }
